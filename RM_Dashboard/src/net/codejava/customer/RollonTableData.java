...
@Entity
@Table(name="rollon_table_data")
public class RollonTableData {
	@Id
	...
	@Column(name = "talentGroup")
	private String talentGroup;
	
	public RollonTableData() {}

	public RollonTableData(Long id, String account, String sourceType, double probability, int p1, int p2, int p3,
			int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, String talentGroup) {
		super();
		this.id = id;
