...
public class RolloffTableData {
	...
	public RolloffTableData() {}
	
	public RolloffTableData(Long id, String account, double probability, int p1, int p2, int p3, int p4, int p5, int p6,
